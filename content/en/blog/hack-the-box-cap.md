+++
author = "Nick"
categories = ["hack the box", "Linux", "ftp", "ssh", "wireshark", "pcap", "cap_setuid"]
date = 2021-10-03T11:12:38Z
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/08/cap.png"
...
Welcome back everyone. Today we are doing the Hack the Box machine - Cap. This is listed as an Easy machine. Let's get to it!

As usual, we start with an `nmap`, here are the results:
...
|     Server: gunicorn
|     Date: Fri, 13 Aug 2021 16:13:31 GMT
|     Connection: close
...
|     HTTP/1.0 200 OK
|     Server: gunicorn
|     Date: Fri, 13 Aug 2021 16:13:25 GMT
|     Connection: close
|     Content-Type: text/html; charset=utf-8
...
SF-Port80-TCP:V=7.91%I=7%D=8/13%Time=61169A27%P=x86_64-pc-linux-gnu%r(GetR
SF:equest,2FE5,"HTTP/1\.0\x20200\x20OK\r\nServer:\x20gunicorn\r\nDate:\x20
SF:Fri,\x2013\x20Aug\x202021\x2016:13:25\x20GMT\r\nConnection:\x20close\r\
...
SF:013\x20Aug\x202021\x2016:13:25\x20GMT\r\nConnection:\x20close\r\nConten
...
SF:ri,\x2013\x20Aug\x202021\x2016:13:31\x20GMT\r\nConnection:\x20close\r\n
...
Command:
`ffuf -u http://10.10.10.245/data/FUZZ -w ./1-100.txt -fs 208`
