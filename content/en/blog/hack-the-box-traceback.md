...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2020/04/info.png"
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-38.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-39.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-40.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-41.png" >}}

{{< figure src="__GHOST_URL__/content/images/2020/04/image-42.png" >}}

Well this is fun! Taking a look around the system using this interface we see there are two users, `sysadmin` and `webadmin`.

{{< figure src="__GHOST_URL__/content/images/2020/04/image-43.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-47.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/traceback_echo.gif" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/traceback_ssh.gif" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-49.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/traceback_user.gif" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/image-45.png" >}}

If we look at the properties of the `update-motd.d` directory we see we actually have access to it.

{{< figure src="__GHOST_URL__/content/images/2020/04/image-44.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/04/traceback_root.gif" >}}
