...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2019/01/curling.PNG"
...
{{< figure src="__GHOST_URL__/content/images/2019/01/floris.PNG" caption="Hinting at a password?" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/secret.PNG" >}}

So naturally, lets try to path to /secret.txt. It worked, it's given us a string.

{{< figure src="__GHOST_URL__/content/images/2019/01/string.PNG" caption="What could this be?" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/msfpc-2.PNG" caption="We supply msfpc the php command for the type, an ip to bind to and verbose output." >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/theme.PNG" caption="The error.php page ready to be modified!" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/session.PNG" caption="One session active!" >}}

{{< figure src="__GHOST_URL__/content/images/2019/01/heh.png" caption="I reached 189 connections before the box rebooted!" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/info2.PNG" caption="Looks like a more current Ubuntu build." >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/florishome.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/download-2.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/bzip0.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/bzip1.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/bzip2.PNG" caption="" >}}

Lets rerun the xxd command but specify it to be a bz2 output.

{{< figure src="__GHOST_URL__/content/images/2019/01/bzip3.PNG" >}}

Now, lets try to unzip the file using bzip2, if we want to keep the file, we can issued the -k (not that I did that...).

{{< figure src="__GHOST_URL__/content/images/2019/01/bzip4.PNG" caption="We supply bzip2 with -d to decompress (and the -k if we wanted to keep it....)" >}}

We now have an unziped file called 'decompiled', lets check the file type of it.

{{< figure src="__GHOST_URL__/content/images/2019/01/bzip5-1.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/bzip9-2.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/bzip10.PNG" >}}

When we cat the file, we see some data that looks like some user ids and a potential password?

{{< figure src="__GHOST_URL__/content/images/2019/01/bzip11.PNG" >}}

Lets check the file type, looks like its a .tar.

{{< figure src="__GHOST_URL__/content/images/2019/01/bzip12.PNG" >}}

Lets rename and extract it. Finally, a password.txt file!

{{< figure src="__GHOST_URL__/content/images/2019/01/bzip13.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/ssh.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/cron1.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/input.PNG" >}}
...
{{< figure src="__GHOST_URL__/content/images/2019/01/cat2.PNG" >}}
